...
![Docker0](https://note.youdao.com/yws/api/personal/file/WEB527494ac026a2b636bb92db9cf530222?method=getImage&version=28&cstk=VyfDo8Y3)
...
![cp command](https://note.youdao.com/yws/api/personal/file/WEBbc9d899e7bd4fd773390438b090bc6ac?method=getImage&version=29&cstk=VyfDo8Y3)
...
![container data volume](https://note.youdao.com/yws/api/personal/file/WEBcff666897b20ca9503e436decaa716a8?method=getImage&version=25&cstk=VyfDo8Y3)     
...
CMD echo "----end----"
```
![dockerfile](https://note.youdao.com/yws/api/personal/file/WEB2709ad8d76a0d44ae062c994b3c65b0f?method=getImage&version=30&cstk=VyfDo8Y3)
...
![dockerfile1](https://note.youdao.com/yws/api/personal/file/WEB697abb05646508fc453b4d060e735b66?method=getImage&version=19&cstk=VyfDo8Y3)
...
![Mounts](https://note.youdao.com/yws/api/personal/file/WEB7c7f7a61b3bd1141e66e6e586649c65f?method=getImage&version=17&cstk=VyfDo8Y3)
...
![creat file in the container](https://note.youdao.com/yws/api/personal/file/WEB9eeb66a00706e1d1db2ad1e8f7cb6807?method=getImage&version=31&cstk=VyfDo8Y3)
<center>Creating container.TXT in Container</center>
![creat file in the container](https://note.youdao.com/yws/api/personal/file/WEB1a1bfe464d7576cc5ff528ad5b4d4b75?method=getImage&version=18&cstk=VyfDo8Y3)
...
![create the first host container](https://note.youdao.com/yws/api/personal/file/WEBdba9a20a650501f636721975f09bab73?method=getImage&version=22&cstk=VyfDo8Y3)
<center>create the first host container</center>

Next, create the child container named docker2 using --volume-from.

![create the second child container](https://note.youdao.com/yws/api/personal/file/WEB4b84d319286de30864ad4e8386d3a963?method=getImage&version=21&cstk=VyfDo8Y3)
...
![check the connection](https://note.youdao.com/yws/api/personal/file/WEBd6560f861b7d30cb4a2cc36d24dd9e03?method=getImage&version=23&cstk=VyfDo8Y3)
...
In this file, there enables the vim & ifconfig commands.
    ...
    ![Write DockerFile](https://note.youdao.com/yws/api/personal/file/WEBb3c51b08720702c08d1492c6415f798f?method=getImage&version=16&cstk=VyfDo8Y3)
    <center>Write DockerFile</center>

2. build this image, and name it as mycentos0.1

    ![Build image](https://note.youdao.com/yws/api/personal/file/WEB3c05c53beae3a2ef12c0dec36ab3863b?method=getImage&version=33&cstk=VyfDo8Y3)
    <center>Build image</center>

3. Run it and test it

    ![Run it and test it](https://note.youdao.com/yws/api/personal/file/WEBc7ed0b26b6ff55ec3eae6e099cf00390?method=getImage&version=9&cstk=VyfDo8Y3)
...
4. Run the original centos image, and it indicated that the basic image does not support the command vim and config
    ...
    ![Original Centos](https://note.youdao.com/yws/api/personal/file/WEB40590c8ebaf191d0a6fe992bd8ea96b3?method=getImage&version=34&cstk=VyfDo8Y3)
